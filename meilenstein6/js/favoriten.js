...
function createTable(arr) {
	...
	if (arr === 'film') {
		...
		get_json('http://localhost:8080/WAW/wasserlosAutosWaschen/meilenstein6/php/getfavorites.php?data=movies',loadData);
		...
		//arr = musik;
		get_json('http://localhost:8080/WAW/wasserlosAutosWaschen/meilenstein6/php/getfavorites.php?data=music',loadData);
